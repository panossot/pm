 ...
 *
 */
public class ObjectParsingFormat implements ParsingFormat {

    public static final ObjectParsingFormat INSTANCE = new ObjectParsingFormat();
    ...
    public void deal(ParsingContext ctx) throws ParsingException {
        if(!Character.isWhitespace(ctx.charNow())) {
            ctx.pushFormat(NameValueParsingFormat.INSTANCE);
        }
    }
